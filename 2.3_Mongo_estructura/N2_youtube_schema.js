    ...
    $jsonSchema: {
      ...
      properties: {
        ...
        playlist: {
          bsonType: 'object',
          title: 'playlist',
          required: ['_id', 'nom', 'datahora', 'estat'],
          additionalProperties: false,
          properties: {
            _id: { bsonType: 'objectId' },
            nom: { bsonType: 'string' },
      ...
      properties: {
        ...
        comentari: {
          ...
          items: {
            ...
            title: 'comentari',
            additionalProperties: false,
            required: ['_id', 'creat_per', 'username', 'datahora', 'text'],
            properties: {
              _id: { bsonType: 'objectId' },
  ...
  usuari: [
    {
      ...
      canal: { _id: ObjectId('61a67af5b4422cb67be5bfb0'), nom: 'canal js', descripcio: 'Videos de js', data_creacio: new Date('2020-05-01') },
      playlist: {
        _id: ObjectId('61a679f5b4422cb67be5bfaf'), nom: 'javascript',
        datahora: new Date('2020-05-05'), estat: 'public', videos: [ObjectId('61a661c9b4422cb67be5bfac'), ObjectId('61a664c7b4422cb67be5bfad')]
      }
    },
    {
